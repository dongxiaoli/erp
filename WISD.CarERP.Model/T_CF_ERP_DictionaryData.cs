...
namespace WISD.CarERP.Model
{
	...
	public partial class T_CF_ERP_DictionaryData
	{
		...
		{}
		#region Model
		private int _dictionarydataid;
		private int _dictionaryfieldid;
		...
		/// 字典数据内容表主键
		/// </summary>
		public int DictionaryDataId
		{
			set{ _dictionarydataid=value;}
			get{return _dictionarydataid;}
		}
		/// <summary>
		/// 字典弹性栏位(外键,T_CF_ERP_DictionaryField)
		/// </summary>
		public int DictionaryFieldId
		{
			set{ _dictionaryfieldid=value;}
			get{return _dictionaryfieldid;}
		}
		/// <summary>
		/// 数据字典的数据内容
		/// </summary>
