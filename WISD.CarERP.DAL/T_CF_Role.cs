...
namespace WISD.CarERP.DAL
{
	...
	public partial class T_CF_Role
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("RoleId", "T_CF_Role"); 
		}
		...
		public bool Exists(int RoleId)
		{
			...
			strSql.Append("select count(1) from T_CF_Role");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_CF_Role(");
			strSql.Append("RoleName,MenuPermission,ActionPermission,DataPermission,Creator,CreateDate,Updater,UpdateDate,Status,Memo,Memo1,Memo2,Memo3,Memo4,Memo5,Memo6,Memo7,Memo8)");
			strSql.Append(" values (");
			strSql.Append("@RoleName,@MenuPermission,@ActionPermission,@DataPermission,@Creator,@CreateDate,@Updater,@UpdateDate,@Status,@Memo,@Memo1,@Memo2,@Memo3,@Memo4,@Memo5,@Memo6,@Memo7,@Memo8)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@RoleName", SqlDbType.NVarChar,100),
					new SqlParameter("@MenuPermission", SqlDbType.NVarChar,500),
					new SqlParameter("@ActionPermission", SqlDbType.NVarChar,500),
					new SqlParameter("@DataPermission", SqlDbType.NVarChar,500),
			...
			parameters[1].Value = model.MenuPermission;
			parameters[2].Value = model.ActionPermission;
			parameters[3].Value = model.DataPermission;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_CF_Role set ");
			strSql.Append("RoleName=@RoleName,");
			strSql.Append("MenuPermission=@MenuPermission,");
			strSql.Append("ActionPermission=@ActionPermission,");
			strSql.Append("DataPermission=@DataPermission,");
		...
		public bool Delete(int RoleId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_CF_Role ");
			strSql.Append(" where RoleId=@RoleId");
			SqlParameter[] parameters = {
					new SqlParameter("@RoleId", SqlDbType.Int,4)
			};
		...
		public WISD.CarERP.Model.T_CF_Role GetModel(int RoleId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 RoleId,RoleName,MenuPermission,ActionPermission,DataPermission,Creator,CreateDate,Updater,UpdateDate,Status,Memo,Memo1,Memo2,Memo3,Memo4,Memo5,Memo6,Memo7,Memo8 from T_CF_Role ");
			strSql.Append(" where RoleId=@RoleId");
			SqlParameter[] parameters = {
					new SqlParameter("@RoleId", SqlDbType.Int,4)
			};
			...
			WISD.CarERP.Model.T_CF_Role model=new WISD.CarERP.Model.T_CF_Role();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["MenuPermission"]!=null && ds.Tables[0].Rows[0]["MenuPermission"].ToString()!="")
				{
					model.MenuPermission=ds.Tables[0].Rows[0]["MenuPermission"].ToString();
				}
				if(ds.Tables[0].Rows[0]["ActionPermission"]!=null && ds.Tables[0].Rows[0]["ActionPermission"].ToString()!="")
				{
					model.ActionPermission=ds.Tables[0].Rows[0]["ActionPermission"].ToString();
				}
				if(ds.Tables[0].Rows[0]["DataPermission"]!=null && ds.Tables[0].Rows[0]["DataPermission"].ToString()!="")
				{
					model.DataPermission=ds.Tables[0].Rows[0]["DataPermission"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select RoleId,RoleName,MenuPermission,ActionPermission,DataPermission,Creator,CreateDate,Updater,UpdateDate,Status,Memo,Memo1,Memo2,Memo3,Memo4,Memo5,Memo6,Memo7,Memo8 ");
			strSql.Append(" FROM T_CF_Role ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" RoleId,RoleName,MenuPermission,ActionPermission,DataPermission,Creator,CreateDate,Updater,UpdateDate,Status,Memo,Memo1,Memo2,Memo3,Memo4,Memo5,Memo6,Memo7,Memo8 ");
			strSql.Append(" FROM T_CF_Role ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_CF_Role T ");
