...
{
	/// <summary>
	/// 数据访问类:T_CF_ERP_DictionaryField
	/// </summary>
	public partial class T_CF_ERP_DictionaryField
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("DictionaryFieldId", "T_CF_ERP_DictionaryField"); 
		}
		...
		public bool Exists(int DictionaryFieldId)
		{
			...
			strSql.Append("select count(1) from T_CF_ERP_DictionaryField");
			strSql.Append(" where DictionaryFieldId=@DictionaryFieldId");
			SqlParameter[] parameters = {
					new SqlParameter("@DictionaryFieldId", SqlDbType.Int,4)
			};
			parameters[0].Value = DictionaryFieldId;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_CF_ERP_DictionaryField(");
			strSql.Append("DictionaryItemId,DictionaryField,Creator,CreateDate,Updater,UpdateDate,Status,Memo,Memo1,Memo2,Memo3,Memo4,Memo5,Memo6,Memo7,Memo8)");
			strSql.Append(" values (");
			strSql.Append("@DictionaryItemId,@DictionaryField,@Creator,@CreateDate,@Updater,@UpdateDate,@Status,@Memo,@Memo1,@Memo2,@Memo3,@Memo4,@Memo5,@Memo6,@Memo7,@Memo8)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@DictionaryItemId", SqlDbType.Int,4),
					new SqlParameter("@DictionaryField", SqlDbType.NVarChar,100),
			...
			parameters[0].Value = model.DictionaryItemId;
			parameters[1].Value = model.DictionaryField;
			parameters[2].Value = model.Creator;
			parameters[3].Value = model.CreateDate;
			parameters[4].Value = model.Updater;
			parameters[5].Value = model.UpdateDate;
			parameters[6].Value = model.Status;
			parameters[7].Value = model.Memo;
			parameters[8].Value = model.Memo1;
			parameters[9].Value = model.Memo2;
			parameters[10].Value = model.Memo3;
			parameters[11].Value = model.Memo4;
			parameters[12].Value = model.Memo5;
			parameters[13].Value = model.Memo6;
			parameters[14].Value = model.Memo7;
			parameters[15].Value = model.Memo8;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_CF_ERP_DictionaryField set ");
			strSql.Append("DictionaryItemId=@DictionaryItemId,");
			strSql.Append("DictionaryField=@DictionaryField,");
			...
			parameters[14].Value = model.Memo7;
			parameters[15].Value = model.Memo8;
			parameters[16].Value = model.DictionaryFieldId;
		...
		public bool Delete(int DictionaryFieldId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_CF_ERP_DictionaryField ");
			strSql.Append(" where DictionaryFieldId=@DictionaryFieldId");
			SqlParameter[] parameters = {
					new SqlParameter("@DictionaryFieldId", SqlDbType.Int,4)
			};
		...
		public bool DeleteList(string DictionaryFieldIdlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_CF_ERP_DictionaryField ");
			strSql.Append(" where DictionaryFieldId in ("+DictionaryFieldIdlist + ")  ");
		...
		public WISD.CarERP.Model.T_CF_ERP_DictionaryField GetModel(int DictionaryFieldId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 DictionaryFieldId,DictionaryItemId,DictionaryField,Creator,CreateDate,Updater,UpdateDate,Status,Memo,Memo1,Memo2,Memo3,Memo4,Memo5,Memo6,Memo7,Memo8 from T_CF_ERP_DictionaryField ");
			strSql.Append(" where DictionaryFieldId=@DictionaryFieldId");
			SqlParameter[] parameters = {
					new SqlParameter("@DictionaryFieldId", SqlDbType.Int,4)
			};
			...
			WISD.CarERP.Model.T_CF_ERP_DictionaryField model=new WISD.CarERP.Model.T_CF_ERP_DictionaryField();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["DictionaryField"]!=null && ds.Tables[0].Rows[0]["DictionaryField"].ToString()!="")
				{
					model.DictionaryField=ds.Tables[0].Rows[0]["DictionaryField"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select DictionaryFieldId,DictionaryItemId,DictionaryField,Creator,CreateDate,Updater,UpdateDate,Status,Memo,Memo1,Memo2,Memo3,Memo4,Memo5,Memo6,Memo7,Memo8 ");
			strSql.Append(" FROM T_CF_ERP_DictionaryField ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" DictionaryFieldId,DictionaryItemId,DictionaryField,Creator,CreateDate,Updater,UpdateDate,Status,Memo,Memo1,Memo2,Memo3,Memo4,Memo5,Memo6,Memo7,Memo8 ");
			strSql.Append(" FROM T_CF_ERP_DictionaryField ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.DictionaryFieldId desc");
			}
			strSql.Append(")AS Row, T.*  from T_CF_ERP_DictionaryField T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "T_CF_ERP_DictionaryField";
			parameters[1].Value = "DictionaryFieldId";
