...
{
    public partial class DictionaryFieldList : Utility.BasicPage
    {
        #region 字段
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    // 验证权限
                    base.CheckPermission("DictionaryField_List");
        ...
        private void BindReapterForPageLoad()
        {
            ...
            // 传递查询条件
            this.m_Keywords = "&id=" + this.m_DictionaryItemId.ToString();

            // 查询数据库
            DataTable dataTable = this.m_DictionaryFieldBLL.GetList(" DictionaryItemId=" + this.m_DictionaryItemId.ToString()).Tables[0];
        ...
        private void BatchDelete()
        {
            ...
            for (int i = 0; i < rptList.Items.Count; i++)
            {
                ...
                if (checkBox.Checked)
                {
                    this.m_DictionaryFieldBLL.Delete(id);
                }
            }
