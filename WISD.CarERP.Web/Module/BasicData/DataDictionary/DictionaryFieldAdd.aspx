<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DictionaryFieldAdd.aspx.cs" Inherits="WISD.CarERP.Web.Module.BasicData.DataDictionary.DictionaryFieldAdd" %>
...
<body style="padding:10px;">
    <form id="form1" runat="server">
        <div class="navigation">
          <span class="back"><a href="DictionaryFieldList.aspx?id=<%=DictionaryItemId %>">返回列表</a></span><b>您当前的位置：首页 &gt; 数据字典管理 &gt; 数据字典栏位管理 &gt; 新增数据字典栏位 </b>
        </div>
        <div style="padding-bottom:10px;"></div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
            <tr>
                <th colspan="2" align="left">新增数据字典栏位</th>
            </tr>
            <tr>
